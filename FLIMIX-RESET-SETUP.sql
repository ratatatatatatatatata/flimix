-- ============================================================
-- FLIMIX — FULL RESET + SETUP (дахин ажиллуулахад аюулгүй)
-- Юу хийдэг вэ:
--   1. public schema-г бүрэн цэвэрлэнэ (контентын хүснэгтүүд устна;
--      auth.users дахь бүртгэлүүд ХЭВЭЭР үлдэнэ)
--   2. Бүх хүснэгт, enum, индекс, RLS бодлого, функцийг шинээр үүсгэнэ
--   3. Бүртгэлтэй бүх хэрэглэгчийн профайлыг сэргээнэ
--   4. turuu.narabaatar0711@gmail.com -д super_admin эрх олгоно
-- ============================================================
...
-- 3) PostgREST-д хандах эрхийг сэргээх (Supabase default)
grant all on all tables in schema public to anon, authenticated, service_role;
grant all on all functions in schema public to anon, authenticated, service_role;
grant all on all sequences in schema public to anon, authenticated, service_role;

-- 4) Бүртгэлтэй бүх хэрэглэгчийн профайл + үндсэн эрхийг сэргээх
insert into public.profiles (user_id, display_name)
...
from auth.users
where email = 'turuu.narabaatar0711@gmail.com'
on conflict do nothing;

-- 6) Шалгалт: доорх хоёр мөр үр дүнд харагдана
...
where u.email = 'turuu.narabaatar0711@gmail.com' and ur.role = 'super_admin';
